"""
Crea un dataset bilanciato 50/50 FAKE/REAL campionando da tutti i file parquet.
"""
import pandas as pd
import glob
...
# Configurazione
TARGET_SIZE = 200_000  # Ridotto a 200k per evitare crash Colab
...
# Rimuovi duplicati prima di campionare
print(f"\nRemoving duplicates...")
...
if len(df_fake) < TARGET_FAKE:
    ...
    TARGET_REAL = TARGET_FAKE  # Mantieni bilanciato
...
if len(df_real) < TARGET_REAL:
    ...
    TARGET_FAKE = TARGET_REAL  # Mantieni bilanciato
...
# Salva
output_file = DATA / "balanced_dataset_500k.parquet"
